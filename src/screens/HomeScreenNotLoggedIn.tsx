...
import { SafeAreaView, ScrollView, StatusBar, StyleSheet, TouchableOpacity, View, Text,Image, Modal, Dimensions } from "react-native"
...
const HomeScreenNotLoggedIn = ({handleLogin} : {handleLogin: () => void}) => {
    ...
    return (
        <SafeAreaView style={[styles.container, styles.paddingVertical, styles.paddingHorizontal]}>
            <StatusBar backgroundColor={modalVisible? colors.DROIDCONKE_MODAL_OVERLAY : colors.DROIDCONKE_WHITE} barStyle='dark-content'/>
            ...
            <Modal transparent visible={modalVisible}>
                <View style={styles.modalContainer}>
                    <View style={styles.modalContentContainer}>
                        <TouchableOpacity onPress={toggleModal}><Text style={styles.textCancel}>CANCEL</Text></TouchableOpacity>
